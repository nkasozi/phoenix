...
import { tiktokCountryList, searchPostBaseLink } from "src/utils/constants";
	...
	return (
		<>
			<TextField
				mb="sm"
				value={translate(
					"gathers.types.apify_tiktok_searches_posts.create_description.part1"
				)}
			/>
			<TextField
				mb="sm"
				value={translate(
					"gathers.types.apify_tiktok_searches_posts.create_description.part2"
				)}
			/>
			<TextField
				mb="sm"
				value={translate(
					"gathers.types.apify_tiktok_searches_posts.create_description.part3"
				)}
			/>
			<TextField
				mb="lg"
				value={translate(
					"gathers.types.apify_tiktok_searches_posts.create_description.part4"
				)}
			/>
			<TextInput
				mt="sm"
